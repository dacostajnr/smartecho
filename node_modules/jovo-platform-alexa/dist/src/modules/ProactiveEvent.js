...
class ProactiveEvent {
    ...
    async sendAuthRequest(clientId, clientSecret) {
        const authObject = await AlexaAPI_1.AlexaAPI.proactiveEventAuthorization(clientId, clientSecret);
        return authObject;
    }
    async sendProactiveEvent(proactiveEvent, accessToken, live = false) {
        ...
        const result = await AlexaAPI_1.AlexaAPI.apiCall(options);
        return result;
    }
}
...
class ProactiveEventPlugin {
    install(alexa) {
        ...
        AlexaSkill_1.AlexaSkill.prototype.$proactiveEvent = undefined;
        AlexaSkill_1.AlexaSkill.prototype.proactiveEvent = function () {
