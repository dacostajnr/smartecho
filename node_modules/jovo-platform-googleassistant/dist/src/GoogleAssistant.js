...
class GoogleAssistant extends jovo_core_1.Extensible {
    ...
    install(app) {
        ...
        this.use(new GoogleAssistantCore_1.GoogleAssistantCore(), new Cards_1.Cards(), new AskFor_1.AskFor(), new MediaResponse_1.MediaResponsePlugin(), new Updates_1.UpdatesPlugin(), new Transaction_1.TransactionsPlugin());
