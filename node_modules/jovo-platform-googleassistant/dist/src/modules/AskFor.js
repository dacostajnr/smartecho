...
class AskFor {
    install(googleAssistant) {
        ...
        GoogleAction_1.GoogleAction.prototype.askForUpdate = function (intent, name, text) {
            return this.askForNotification(intent, name, text);
        };
        GoogleAction_1.GoogleAction.prototype.askForNotification = function (intent, name, text) {
            this.$output.GoogleAssistant = {
