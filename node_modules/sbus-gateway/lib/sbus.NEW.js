...
var sbus = {
  ...
  processData: function(matchedString) {
    ...
    // var deviceType = parseInt((matchedString[5].charCodeAt(0)).toString(2)+(matchedString[6].charCodeAt(0)).toString(2),2);
    ...
    // console.log(opCode, sbus.bin2String(matchedString));
    switch (opCode) {
      case '34':
      ...
      case '12d':
        ...
        break;
      case 'd995':
        returnObject.type = 'Sensor';
        returnObject.totalChannels = 7;
        returnObject.channelStatus = sbus.Processdata_SB(matchedString.substring(11), returnObject.totalChannels);
        returnObject.group = '2';
        returnObject.MBvalid = true;
        break;
      case '192F':
      ...
      case 'DC22':
        returnObject.type = '4Z';
        returnObject.totalChannels = matchedString[11].charCodeAt(0);
        returnObject.channelStatus = sbus.Processdata_SB(matchedString.substring(16), returnObject.totalChannels);
        returnObject.group = '1';
        returnObject.MBvalid = true;
        break;
      default:
    ...
    /*
        ...
        if (sbus.rgxZoneAudioStatusON.test(matchedString)) {
            //    rgxZoneAudioStatusON: /\xAA\xAA(.)(.)(.
            )(.)(.)\x19\x2F(.)(.)#Z(.*),(.*),SRC(.*),VOL(.*)\x0D(.*)/i,
