...
class App extends jovo_core_1.BaseApp {
    ...
    useComponents(...components) {
        components.forEach(component => {
            ...
            const componentAppConfig = _cloneDeep(this.$config.plugin[component.name]); // config defined in project's main config.js file
            ...
            if (this.constructor.name === 'App') {
                jovo_core_1.Log.yellow().verbose(`Installed component: ${component.name}`);
                jovo_core_1.Log.debug(`${JSON.stringify(component.config || {}, null, '\t')}`);
