...
class Router {
    ...
    async router(handleRequest) {
        ...
        if (route.type === jovo_core_1.EnumRequestType.INTENT) {
            ...
            let component;
            if (handleRequest.jovo.getSessionAttribute(jovo_core_1.SessionConstants.COMPONENT)) {
                component =
                    handleRequest.jovo.$components[handleRequest.jovo.getSessionAttribute(jovo_core_1.SessionConstants.COMPONENT)];
            }
