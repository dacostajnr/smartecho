...
import { HandleRequest, Host, Inputs, JovoData, JovoRequest, JovoResponse, JovoSession, NLUData, Output, RequestType, SessionAttributes, SessionData } from './Interfaces';
...
export declare abstract class Jovo extends EventEmitter {
     ...
     */
    parseForValidator(validator: () => void | Validator, input: any, failedValidators: string[][]): void;
    /**
     ...
     * @throws JovoError if the validator has an unsupported type.
     */
    parseForValidatorAsync(validator: () => void | Validator, input: any, failedValidators: string[][]): Promise<void>;
}
